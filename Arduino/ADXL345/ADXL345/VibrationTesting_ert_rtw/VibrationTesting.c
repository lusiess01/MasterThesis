...
void VibrationTesting_initialize(void)
{
  ...
  VibrationTesting_M->Timing.stepSize0 = 0.01;

  /* External mode info */
  VibrationTesting_M->Sizes.checksums[0] = (573621194U);
  VibrationTesting_M->Sizes.checksums[1] = (2484908096U);
  VibrationTesting_M->Sizes.checksums[2] = (1314383855U);
  VibrationTesting_M->Sizes.checksums[3] = (2733620329U);
