###########################################################################
## Makefile generated for component 'VibrationMotor'. 
## 
## Makefile     : VibrationMotor.mk
## Generated on : Wed Feb 26 22:45:21 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/VibrationMotor.elf
...
PRODUCT_NAME              = VibrationMotor
MAKEFILE                  = VibrationMotor.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/11_GIT/MasterThesis/Arduino/ADXL345/ADXL345
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = VibrationMotor_comp.rsp
CMD_FILE                  = VibrationMotor.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/VibrationMotor.elf
...
DEFINES_STANDARD = -DMODEL=VibrationMotor -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_I2C.o MW_GetPeripheralObjects.o xcp_ext_mode.o VibrationMotor.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o blapp_support.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
LDFLAGS_ = @D:\11_GIT\MasterThesis\Arduino\ADXL345\ADXL345\VIBRAT~1\MBED_O~1.RSP
...
SHAREDLIB_LDFLAGS_ = @D:\11_GIT\MasterThesis\Arduino\ADXL345\ADXL345\VIBRAT~1\MBED_O~1.RSP
...
CPP_LDFLAGS_ = @D:\11_GIT\MasterThesis\Arduino\ADXL345\ADXL345\VIBRAT~1\MBED_O~1.RSP
...
CPP_SHAREDLIB_LDFLAGS_ = @D:\11_GIT\MasterThesis\Arduino\ADXL345\ADXL345\VIBRAT~1\MBED_O~1.RSP
...
%.o : $(START_DIR)/VibrationMotor_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/VibrationMotor_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/VibrationMotor_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/VibrationMotor_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/VibrationMotor_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
VibrationMotor.o : $(START_DIR)/VibrationMotor_ert_rtw/VibrationMotor.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/VibrationMotor_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
