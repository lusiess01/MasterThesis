...
void VibrationTesting_initialize(void)
{
  ...
  rtmSetTFinal(VibrationTesting_M, -1);
  VibrationTesting_M->Timing.stepSize0 = 0.00125;

  /* External mode info */
  VibrationTesting_M->Sizes.checksums[0] = (3787697779U);
  VibrationTesting_M->Sizes.checksums[1] = (4024857026U);
  VibrationTesting_M->Sizes.checksums[2] = (410584929U);
  VibrationTesting_M->Sizes.checksums[3] = (3708342745U);
